  ...
  return (
    <>
      ...
      <div
        ...
        className={clsx(
          sizes[context.size],
          "overflow-hidden fixed top-0 md:top-1/2 left-0 md:left-1/2 z-50 p-4 w-full h-full md:max-h-4/5 md:h-auto md:-translate-x-1/2 md:-translate-y-1/2 bg-white h-full rounded-lg shadow p-4 flex flex-col"
        )}
      >
        {children}
      </div>
